/*
  ...
  - Added the required column `initialPuzzle` to the `SudokuGame` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_SudokuGame" ("board", "createdAt", "id", "level", "puzzle", "updatedAt", "userId") SELECT "board", "createdAt", "id", "level", "puzzle", "updatedAt", "userId" FROM "SudokuGame";
